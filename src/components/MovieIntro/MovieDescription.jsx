...
export default function MovieDescription({ currentIntro }) {
  return (
    <div className="flex flex-col justify-center items-start h-[600px] w-96 gap-4">
      ...
      <a href="#" className="flex justify-center items-center gap-2 py-2 px-6 bg-red-800 rounded-md hover:bg-red-700 duration-300 text-sm cursor-pointer font-bold tracking-wider uppercase">
        <span>
