...
export default function MovieCard({type, item}) {
    console.log(item);
    const showGenres = () => {
    ...
    return (
        <div>
            <img className='m-width-[200px]' src={`https://image.tmdb.org/t/p/w342/${item.poster_path}`} alt={`${item.title} poster`} width="200" height="300" />
